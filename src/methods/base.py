...
Every training strategy (Baseline, SCE, ELR, AsyCo) is a subclass. The
...
Methods with multiple networks (AsyCo) own multiple optimizers and step them
all internally inside `train_step`. The external runner doesn't know or care.
