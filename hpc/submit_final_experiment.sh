...
#
# Submit the Main Experiment to LSF: methods (4) x dataset (1) x init (1) x
# optim (1) x tau (6) x fold (10) = 240 jobs, in method-major / fold / tau
# order. All knobs are env-var-overridable (defaults below).
#
